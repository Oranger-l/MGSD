# Case 05: minibehaviour level5

- case_id: `minibehaviour_test_level5_0504`
- task: `minibehaviour`
- level: `5`
- input_modality: `text`
...
Grid size: 5x5
Agent position: (2,4)
Printer position: (1,1)
Table cells: (3,1); (3,2); (3,3); (4,1); (4,2); (4,3)
...
.TTT.
.TTT.
Cells adjacent to the printer where PICK is legal: (0,1); (1,0); (1,2); (2,1)
Cells adjacent to the table where DROP is legal after PICK: (2,1); (2,2); (2,3); (3,0); (3,4); (4,0); (4,4)
